...
Class Rule{
	...
	function getPrice($start,$config_price,$address_temp=false){
		if(isset($_POST['address'])==true || $address_temp!=false){
			...
			$xml =simplexml_load_file("https://maps.googleapis.com/maps/api/distancematrix/xml?key=AIzaSyAJtj702YJyv-iq_atu11d2_5ENpezHLqI&origins=$start&destinations=$address&mode=walking&language=de&sensor=true");

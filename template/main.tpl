	...
	<section id="shop">
		...
		<aside class="right"  id='mobile_cart'>
			...
			<!-- 		<li style="float:left"><img src="style/images/cc-visa.png" alt="cc"></li>
						...
						<li style="float:left; color:white"> Zahlungsmethode: Bar, <img src="style/images/cc-paypal.png" alt="cc"></li>
					</ul>
				...
				<li class='root_append ' item="{COUNT_DISHIS}" style="margin: 0 12px 30px 0; border-style: ridge;">
					...
					<div class="beilage-list" style="text-align:center; ">
						...
						<div class="count_ds">
                            ...
                            <div class="button_beilage" style="clear:both;display:block;height:100%;margin-top:10px;margin-bottom:15px;margin-left:16%;">

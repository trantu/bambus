...
**/
	...
	$de_main['timeout']['timeout_title']="Zurzeit keine Bestellannahme! Bitte beachten Sie unsere Öffnungszeiten. Wir haben täglich von 11 bis 22 Uhr auf. Mittwoch ist Ruhetag. <br> Wir bedanken uns herzlich bei Ihnen. <br><br> Ihr Bambusstäbchen Team.";//tieu de thoi gian het gio
...
**/
	...
	$de_cart['cart']['side-dish']="Beilagen und Zutaten wählen ";//title món ăn thêm
...
**/
 ...
 /* THÔNG BÁO LỖI KHI CHECKOUT*/
	...
	$de_checkout['alert_paid']="Vielen Dank. Wir haben Ihre Bestellung erhalten. Die normale Lieferzeit beträgt ca. 45 Minuten, sonntagabends ca. 60-75 min";
